...
SUBNET1_NAME           = config_instance.get('VPC', 'SUBNET1_NAME')
SUBNET1_CIDR_BLOCK     = config_instance.get('VPC', 'SUBNET1_CIDR_BLOCK')
SUBNET1_REGION         = config_instance.get('VPC', 'SUBNET1_REGION')
...
if __name__ == '__main__':
    ...
    subnet_pub = create_subnet(ec2=ec2, vpc=vpc, subnet_name=SUBNET1_NAME,
                            subnet_region=SUBNET1_REGION, 
                            subnet_cidr_block=SUBNET1_CIDR_BLOCK,
                            subnet_type='public')
    ## create a private subnet
    subnet_prv = create_subnet(ec2=ec2, vpc=vpc, subnet_name=SUBNET2_NAME,
                            subnet_region=SUBNET2_REGION, 
                            subnet_cidr_block=SUBNET2_CIDR_BLOCK,
                            subnet_type='private')
